...
(define p1 (make-particle 10 20 30 -40))
(define p2 (make-particle 10 20 0 0))
(define p3 (make-particle 10 20 -10 0))
(define p4 (make-particle 10 20 0 30))


(define r1 (make-rect 0 100 0 150))
(define r2 (make-rect 0  20 0 150))
(define r3 (make-rect 0  25 0 150))
(define r4 (make-rect 25 25 150 0))
 
(check-equal?
 (particle-after-tick p1 r1)
 (make-particle 25 0 30 40)
 "particle bounces off y = 0")

(check-equal?
 (particle-after-tick p1 r2)
 (make-particle 20 (- 20 40/3) -30 -40)
 "particle bounces off x = 20")

(check-equal?
 (particle-after-tick p1 r3)
 (make-particle 25 0 -30 40)
 "the particle bounces off y = 0 at the corner x = 25")

(check-equal?
 (particle-after-tick p2 r4)
 (make-particle 10 20 0 0))

(check-equal?
 (particle-after-tick p3 r1)
 (make-particle 0 20 10 0))

(check-equal?
 (particle-after-tick p4 r1)
 (make-particle 10 50 0 30))
